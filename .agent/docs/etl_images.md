...
## � Workflow Completo
1. **Descarga y Almacenamiento**: `image_loader.py` procesa JSONs de ETL-PROPERTIES, descarga imágenes, convierte a WebP y guarda en `/app/storage/images/{client_id}/{property_id}/{hash}.webp`.
